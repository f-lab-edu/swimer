...
export function PaperclicpIcon() {
  return (
    <svg
      className="text-blue-500 inline-flex items-center w-7 h-7"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
      strokeWidth="1.5"
...
export function AwardsIcon(topAuthors: {index: number}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 384 512"
      className="text-blue-500 inline-flex items-center w-6 h-6"
    >
      <path
        fill={getSvgColor(topAuthors.index)}
...
export function FishIcon(props: {index: number; reviews: number}) {
  return (
    <>
      <Tooltip content={userLevelLabel(props.index)} key={props.index}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 576 512"
          className="text-blue-500 inline-flex items-center w-8 h-8 mr-1"
        >
          <path
            fill={
              props.index < Math.floor(props.reviews / 3)
                ? '#1079ea'
                : '#CCCCCC'
            }
